...
import { FaBaby, FaThermometerHalf, FaPills, FaExclamationTriangle, FaInfoCircle } from 'react-icons/fa';
...
const CareCoPilot = () => {
  ...
  const formatResponse = (text) => {
    ...
    return text
      ...
      .replace(/$/, '</p>')
      .replace(/<li class="ml-4 mb-1">• (.*?)<\/li>/g, '<li class="ml-4 mb-2 text-gray-700">• $1</li>');
  };
      ...
      <div className="max-w-4xl mx-auto px-4">
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <ul className="mt-2 text-sm text-red-700 space-y-1">
                    <li>• Never give medication to children under 2 without consulting a doctor</li>
                    <li>• Always verify dosage with a healthcare professional</li>
                    <li>• Seek immediate medical attention if symptoms worsen</li>
                    <li>• This AI cannot diagnose or provide medical treatment</li>
                  </ul>
                </div>
              </div>
            </div>
        ...
        <div className="mt-8 bg-white rounded-lg shadow-lg p-6">
          ...
          <div className="grid md:grid-cols-2 gap-4 text-sm text-gray-700">
            ...
            <div>
              <h4 className="font-medium text-orange-600 mb-2">Call Doctor If:</h4>
              <ul className="space-y-1">
