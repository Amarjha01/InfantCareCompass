...
const blogs = [
  ...
  },
  {
    ...
    description: 'Essential tips for creating a safe and comfortable sleep space that promotes healthy sleep patterns for your infant.',
  ...
  },
  {
    ...
    description: 'Complete checklist and expert advice on making your home safe for your curious little explorer.',
...
const categories = ['All', 'Newborn Care', 'Health', 'Nutrition', 'Sleep', 'Safety', 'Development'];
